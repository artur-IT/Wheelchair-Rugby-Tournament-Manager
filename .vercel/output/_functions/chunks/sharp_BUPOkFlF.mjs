import { A as AstroError, b9 as MissingSharp } from './sequence_C_bNAUSZ.mjs';
import { b as baseService, p as parseQuality } from './generic_CjxKBI8L.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BULJ8sDb.mjs').then(n => n.i)).default;
  } catch {
