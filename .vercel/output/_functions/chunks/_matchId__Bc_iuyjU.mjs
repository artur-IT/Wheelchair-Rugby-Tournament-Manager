...
import { u as updateRefereePlanMatchForTournament } from './refereePlan_C-rSzYcD.mjs';
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (error.message === "REFEREES_LOCKED_MATCH_HAS_RESULT")
        return json(
          {
            error: "Nie można zmienić sędziów, gdy wynik meczu jest już wpisany. Usuń wynik w planie meczów, aby edytować obsadę."
          },
          409
        );
    }
